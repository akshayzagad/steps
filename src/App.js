      ...
      {isOpened && (
        <div className="steps">
          ...
          <div className="buttons">
            <Button textColor='#fff' bgColor='#7950f2' onClick={() => alert(`Learn how to ${messages[step - 1]}`)}>
              Learn How
            </Button>
          </div>
          </StepMessage>
          ...
          <div className="buttons">
            <Button textColor='#fff' bgColor='#7950f2' onClick={previous}><span>⏮️</span> Previous</Button>
            <Button textColor='#fff' bgColor='#7950f2' onClick={next}>Next <span>⏭️</span></Button>
